	...
	def run(self):
		...
		if os.path.exists(MeshDict_file) == True:
			if msh_t == 'blockMesh':
				...
				msh_bash_file.close()
			elif msh_t == 'foamyHexMesh':
				msh_bash_file = open(prj_path_val_th + '/' + mesh_name_txt_val_th + '/' + 'mesh_script', 'w')
				fHM_str_1 = "\nsurfaceOrient constant/triSurface/cone.stl constant/triSurface/cone_orient.stl -inside '(0 -0.5 0)' \n \n"
				fHM_str_2 = "surfaceOrient constant/triSurface/sphere.stl constant/triSurface/sphere_orient.stl -inside '(0 -0.5 0)' \n \n"
				fHM_str_3 = "surfaceBooleanFeatures constant/triSurface/cone_orient.stl constant/triSurface/sphere_orient.stl intersection \n \n"
				fHM_str_4 = "foamyHexMesh \n \n"
				fHM_str_5 = "collapseEdges -latestTime -collapseFaceSet indirectPatchFaces \n \n"
				fHM_str_6 = "collapseEdges -latestTime -collapseFaces \n \n"  
                  
				msh_bash_file.write('#!/bin/sh' + '\n' + '\n' + '. /opt/openfoam6/etc/bashrc' + '\n' + fHM_str_1 + fHM_str_2 + fHM_str_3 + fHM_str_4 + fHM_str_5 + fHM_str_6 + '\n' + 'exit')
				msh_bash_file.close()
