...
class second_toolbar_functions_class():
    ...
    def on_visual_msh_run(prj_path_val, mesh_name_txt_val, pp_dir, par, interface_lng_val, msh_type):
        ...
        par.connect(par.mv, QtCore.SIGNAL("started(PyQt_PyObject, QString, QString)"), msh_functions_class.on_msh_visual_run)
        par.connect(par.mv, QtCore.SIGNAL("finished(int, QString, QString, PyQt_PyObject, QString, QString)"), msh_functions_class.on_msh_visual_finished)
        par.mv.start()
